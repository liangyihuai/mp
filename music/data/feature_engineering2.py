...
# target_count_map = {};
# target_count_column = [];
# filter_msno = train.loc[train['target'] == 1, ['song_id']]
# for name, group in filter_msno['song_id'].groupby(filter_msno['song_id']):
#     target_count_map[name] = group.count();
#
# for row in train.itertuples():
#     song_id = row[2];
#     if target_count_map.has_key(song_id):
#         target_count_column.append(target_count_map[song_id])
#     else:
#         target_count_column.append(0)
#
# target_count_test_column = [];
# for row in test.itertuples():
#     song_id = row[3];
#     if target_count_map.has_key(song_id):
#         target_count_test_column.append(target_count_map[song_id]);
#     else:
#         target_count_test_column.append(0);
#
#
# train['target_count_song'] = pd.Series(target_count_column, dtype=np.uint);
# test['target_count_song'] = pd.Series(target_count_test_column, dtype=np.uint)
#
#
# ###
# target_count_map = {};
# target_count_column = [];
# filter_msno = train.loc[train['target'] == 1, ['msno']]
# for name, group in filter_msno['msno'].groupby(filter_msno['msno']):
#     target_count_map[name] = group.count();
#
# for row in train.itertuples():
#     msno = row[1];
#     if target_count_map.has_key(msno):
#         target_count_column.append(target_count_map[msno])
#     else:
#         target_count_column.append(0)
#
# target_count_test_column = [];
...
#     msno = row[2];
#     if target_count_map.has_key(msno):
#         target_count_test_column.append(target_count_map[msno]);
#     else:
#         target_count_test_column.append(0);
#
#
# train['target_count_user'] = pd.Series(target_count_column, dtype=np.uint);
# test['target_count_user'] = pd.Series(target_count_test_column, dtype=np.uint)
