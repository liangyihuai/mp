...
# 划分数据集
X_train, X_val, y_train, y_val = train_test_split(X_train, y_train, test_size=0.01, random_state=1729)
...
xlf.fit(X_train, y_train, eval_metric='rmse', verbose = True, eval_set = [(X_val, y_val)],early_stopping_rounds=200)

# 计算 auc 分数、预测
predictions = xlf.predict(X_test)
